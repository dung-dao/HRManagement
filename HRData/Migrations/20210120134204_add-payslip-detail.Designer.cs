...
namespace HRData.Migrations
{
    ...
    [Migration("20210120134204_add-payslip-detail")]
    partial class addpayslipdetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRData.Models.SalaryModels.PayRoll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRData.Models.SalaryModels.PaySlip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("HolidayTimeOff")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("UnpaidTimeOff")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HRData.Models.SalaryModels.PayRoll", b =>
                {
                    b.HasOne("HRData.Models.Employee", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("HRData.Models.SalaryModels.PaySlip", b =>
                {
                    ...
                    b.HasOne("HRData.Models.SalaryModels.PayRoll", "PayRoll")
                        .WithMany("PaySlips")
